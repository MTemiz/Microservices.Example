...
public static class RabbitMQSettings
{
    ...
    public const string Order_PaymentCompletedEventSendEmailQueue = "order-payment-success-send-email-queue";
    public const string Order_PaymentFailedEventSendEmailQueue = "order-payment-failed-send-email-queue";
